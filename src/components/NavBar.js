      ...
      <nav className="bg-yellow-400 opacity-100 relative flex flex-wrap items-center justify-between py-4 mb-0 sticky top-0 z-40">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
            <div className="">
            <img src={memoji} alt="logo" className="animate-pulse h-14 w-14 rounded-full border border-yellow-700" />
            </div>
          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto text-xs md:text-sm lg:border lg:border-yellow-700 lg:rounded-full md:shadow-lg">
              <li>
                <NavLink
                  className="nina px-5 py-0 relative block text-center tracking-widest overflow-hidden flex items-center uppercase font-bold leading-snug hover:opacity-75 ml-2"
                  data-text="Blog"
                  onClick={() => setNavbarOpen(!navbarOpen)}
                  to="/post"
                >
